  ...
  return (
    <div className="container">
      ...
      <div className="form-container">
        <p>
          This page will deploy the main GreenChain smart contract to the blockchain.
          Ensure your wallet is connected to the correct network.
        </p>
        <button onClick={handleDeploy} className="submit-button" disabled={isDeploying}>
        ...
        {contractAddress && (
          <div>
            ...
            <p>This address has been saved in your browser's local storage for other pages to use.</p>
          </div>
        )}
      </div>
    </div>
